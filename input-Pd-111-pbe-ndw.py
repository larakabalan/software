...
a = 3.834 # approximate lattice constant
b = a / 2   
...
#mask0 = [atom.tag > 8 for atom in slab]
...
energy_opt_surface = optimised_surface.get_potential_energy()

print(slab.get_potential_energy())
print(optimised_surface.get_potential_energy())

slab.get_cell()
slab_cell=slab.get_cell()
print('slab_parameters', slab_cell)
